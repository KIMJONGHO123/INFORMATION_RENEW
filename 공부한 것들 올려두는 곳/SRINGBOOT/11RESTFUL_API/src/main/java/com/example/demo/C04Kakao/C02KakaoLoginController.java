...
//    @GetMapping("/getCode")
    ...
    public void logout(){
        ...
        // 요청헤더
        HttpHeaders header = new HttpHeaders();
        header.add("Authorization","Bearer "+this.kakaoTokenResponse.getAccess_token()); // 내가 누구인지 인증하는 코드(나 이 access_token 가진 사용자야 하고 신원 인증을 하는 것이다.)
...
//    @GetMapping("/getCode")
    public String getCodeMsb(){
        log.info("GET /kakao/getCodeMsb...");
