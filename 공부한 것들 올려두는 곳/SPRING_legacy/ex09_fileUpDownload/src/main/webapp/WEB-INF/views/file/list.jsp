...
<body>
	...
	<c:forEach items='${uploadPath.listFiles()}' var='subdir'>
		...
		<br>
		-FILE : ${file.getPath() }
			<%-- <a href="${pageContext.request.contextPath }/file/download?dir=${subdir.getName()}&filename=${file.getName()}"> --%>
			<a href="javascript:void(0)" class="item" data-dir="${ subdir.getName()}" data-filename="${ file.getName()}">
				${file.getPath() }
			</a> 
		</c:forEach>
		<hr>
